...
/* USER CODE BEGIN 0 */
extern uint16_t HRTIM_DMA_Buffer[];
/* USER CODE END 0 */
...
void MX_HRTIM1_Init(void)
{
  ...
  pTimerCfg.DMADstAddress = (uint32_t)&(HRTIM1->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_A].CMP1xR);
  pTimerCfg.DMASize = 1;
  ...
  pCompareCfg.CompareValue = MAX_PWM_DUTY_CYCLE;
